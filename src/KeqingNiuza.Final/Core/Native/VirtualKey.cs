...
public enum VirtualKey : ushort
{
    ...
    /// </summary>
    [Obsolete("Use VK_HANGUL instead")] VK_HANGEUL = 0x15,
    ...
    /// </summary>
    /// <remarks>
    ///     Used only as parameters to <see cref="GetAsyncKeyState" /> and  <see cref="GetKeyState" />. * No other API or
    ///     message will distinguish left and right keys in this way.
    /// </remarks>
    VK_LSHIFT = 0xA0,
    ...
    /// </summary>
    /// <remarks>
    ///     For more information, see Remark in <see cref="KEYBDINPUT" />, <see cref="SendInput(int, INPUT*, int)" />,
    ///     <see cref="Msg.WM_KEYDOWN" />, and <see cref="Msg.WM_KEYUP" />
    /// </remarks>
    VK_PACKET = 0xE7,
