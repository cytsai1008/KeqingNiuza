...
internal class CharacterInfo
{
    ...
    [JsonIgnore] public string ToThumb => $"Resource/Character/{Path.GetFileName(FaceIcon)}";

    [JsonIgnore] public string ToPortrait => $"Resource/Character/{Path.GetFileName(GachaSplash)}";
}